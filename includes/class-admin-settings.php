        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr><th scope="row"><?php esc_html_e('AI Prompt Template', AI_SHARE_LINKS_TEXT_DOMAIN); ?></th><td><textarea name="ai_share_links_options[ai_prompt]" rows="5" class="large-text code"><?php echo esc_textarea($options['ai_prompt']); ?></textarea><p class="description"><?php esc_html_e('Supported tokens: {URL}, {SITE}, {TITLE}, {TYPE}, {POST_TYPE}, {CATEGORY}, {TAGS}, {EXCERPT}. Prompt values are replaced at click time; tokens with no available value are replaced with an empty string. Href links remain as fallback.', AI_SHARE_LINKS_TEXT_DOMAIN); ?></p></td></tr>
